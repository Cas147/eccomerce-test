...
const FilterPanel = () => {
  ...
  return (
    <div className=" col-lg-2 d-flex justify-content-center p-0  justify-content-center d-sm-none d-lg-flex filterContainer">
      <div style={{ width: "80%" }}>
        <h6
        ...
        <div className="card w-100 border-0 shadow my-3 bg-body rounded my-3">
